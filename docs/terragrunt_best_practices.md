...
- **Auto-Approval**: When running in non-interactive mode (e.g., via `TERRAGRUNT_NON_INTERACTIVE=true`), Terragrunt **automatically** assumes/passes auto-approval for `run-all` operations.
